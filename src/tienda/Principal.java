...
public class Principal {
    ...
    private VectorPeliculas listapeliculas = new VectorPeliculas();
    ...
    public Principal(){
        ...
        while(menu >= 0){
            ...
            if(menu == 7){
                //ordenar peli  ascendente z-A
                listapeliculas.ordenarPorNombre(0);
            }
            if(menu==8){
                //ordenar peli  descendente A-Z
                listapeliculas.ordenarPorNombre(1);
